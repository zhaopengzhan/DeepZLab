...
from models.BEIT.modeling_finetune_no_cross import VisionTransformer
...
class MyModel(nn.Module):
    def __init__(self, in_chan=10, width=64, num_classes=17):
        super().__init__()
        ...
        self.trans = VisionTransformer(patch_size=16, num_classes=num_classes, embed_dim=384, depth=12, num_heads=12,
                                       mlp_ratio=4, qkv_bias=True,
                                       norm_layer=partial(nn.LayerNorm, eps=1e-6), in_chans=3)
