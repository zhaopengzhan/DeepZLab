...
def parse_args():
    ...
    parser.add_argument(
        '--cfg',
        type=str,
        default=r'F:\Projects\GroupViT\configs\group_vit_gcc_redcap_30e.yml',
        required=False,
    ...
    parser.add_argument('--resume', default=r'F:\Projects\GroupViT\weights\group_vit_gcc_redcap_30e-3dd09a76.pth', help='resume from checkpoint')
    parser.add_argument(
        '--vis',
