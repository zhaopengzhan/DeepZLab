...
class EfficientViT_Seg(nn.Module):
    def __init__(self, in_channel, num_classes):
        super(EfficientViT_Seg, self).__init__()
        self.backbone = EfficientViT(in_chans=in_channel,num_classes=num_classes)  
...
if __name__ == '__main__':
    img = torch.randn(16, 4, 224, 224).cuda()
    model = EfficientViT(in_chans=4,num_classes=7).cuda()
    x=model(img)
    # print(x.shape)