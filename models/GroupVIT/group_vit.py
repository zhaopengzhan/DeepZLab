...
from .transformer import ProjectMLP, get_text_embedding
...
class GroupingBlock(nn.Module):
    ...
    def forward(self, x, group_tokens, return_attn=False):
        ...
        return torch.cat([x, new_x], dim=1), attn_dict
...
class GroupViT(nn.Module):
    ...
    def forward_features(self, x, *, return_attn=False):
        ...
        return x, group_token, attn_dict_list, feat_list
    ...
    def forward(self, x, *, return_feat=False, return_attn=False, as_dict=False):
        ...
        x, group_token, attn_dicts, feat_list = self.forward_features(x, return_attn=return_attn)
        ...
        if return_feat:
            ...
            outs.append(feat_list, name='feat_list')
