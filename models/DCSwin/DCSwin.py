...
class DCSwin(nn.Module):
    def __init__(self,
        ...
        self.backbone = SwinTransformer(embed_dim=embed_dim, depths=depths, num_heads=num_heads,
                                        frozen_stages=frozen_stages, in_chans=in_channels)
...
def dcswin_base(pretrained=True, num_classes=4, in_channels=3, weight_path='pretrain_weights/stseg_base.pth'):
...
def dcswin_small(pretrained=True, num_classes=4, in_channels=3, weight_path='pretrain_weights/stseg_small.pth'):
...
def dcswin_tiny(pretrained=True, num_classes=4, in_channels=3, weight_path='pretrain_weights/stseg_tiny.pth'):
    model = DCSwin(encoder_channels=(96, 192, 384, 768),
                   num_classes=num_classes,
                   embed_dim=96,
                   depths=(2, 2, 6, 2),
...
if __name__ == '__main__':
    ...
    model = dcswin_tiny(pretrained=False, num_classes=9,in_channels=4)
    # model = dcswin_base(pretrained=False,num_classes=4)
    # model = dcswin_small(pretrained=False,num_classes=4)
