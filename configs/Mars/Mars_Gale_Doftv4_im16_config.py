...
class ConfigManager(BaseConfig):
    ...
    def set_config(self):
        ...
        # save
        job_name = f'{args.mobile_name}_cls{args.num_classes}_in{args.in_channels}_exam2_{args.label_type}'
    ...
    def set_val_list(self):
        val_list = [r'F:\datasets\competition\Mars\train\GaleCrater_train_img_mask.tif']
        return val_list
        pass
