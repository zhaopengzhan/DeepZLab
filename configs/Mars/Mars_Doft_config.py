...
class ConfigManager(BaseConfig):
    ...
    def set_config(self):
        ...
        # model
        args.num_classes = 6
        args.in_channels = 168
        args.mobile_name = 'Doft'
        args.label_type = 'CopratesChasma'
        ...
        args.batch_size = 12
        args.num_workers = 3
        args.num_chips_per_tile = 24
        args.image_size = 14
        args.stride = 7

        # path
        args.image_re_path = r'F:\datasets\competition\Mars\train\CopratesChasma_train_img_mask.tif'
    ...
    def set_val_list(self):
        val_list = [r'F:\datasets\competition\Mars\train\CopratesChasma_train_img_mask.tif']
        return val_list
        pass
    ...
    def set_val_one_epoch(self):
        from trainer.mars.val_mars import val_one_epoch
